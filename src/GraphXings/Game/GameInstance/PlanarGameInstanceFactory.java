 ...
 * mode 1 - the dual of a planar triangulation (i.e., a triconnected cubic
 * planar graph)
 * mode 2 - a random subgraph of mode 0, where each edge is selected with a
 * probability prob
 */
public class PlanarGameInstanceFactory implements GameInstanceFactory {
	 ...
	 * 
	 * @param n          The desired number of vertices. If dual is true, the output
	 *                   will have 2n-4 vertices.
	 * @param dual       If true, provides the dual graph of a triangulation on n
	 *                   vertices instead.
	 * @param randomEdge If true, each edge of the primal graph is added with
	 *                   probability prob.
