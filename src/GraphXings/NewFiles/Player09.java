 ...
 */
public class Player09 implements NewPlayer {
    /**
     ...
     */
    public Player09(double percentage, double relativeCircleSize, int sampleSize, int vertexSampleSize,
            Strategy strategy) {
        ...
        // fixed attributes
        this.name = "Player09_" + strategy + "_" + percentage + "_" + relativeCircleSize + "_" + sampleSize + "_"
                + vertexSampleSize;
        this.r = new Random(this.name.hashCode());
    }
    ...
    public GameMove treeMinimizer(GameMove lastMove, Coordinate center, int treeWidth, int treeHeight,
        ...
        try {
            ...
            return getBruteForceMove(false, lastMove, includeAngles); // Found no easy move, do some random stuff and
                                                                      // try again
        } catch (Exception ex) {
    ...
    public GameMove getBruteForceMove(boolean maximize, GameMove lastMove, boolean includeAngles) {
        ...
        for (int sample = 0; sample < sampleSize; sample++) {
            ...
            for (Vertex vertexToSample : verticesToSample) {
                ...
                double crossingsAddedByVertex = betterEdgeCrossingRTree.testCoordinate(vertexToSample, coordinateToAdd,
