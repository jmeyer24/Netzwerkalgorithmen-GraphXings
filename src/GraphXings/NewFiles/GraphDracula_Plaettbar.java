 ...
 */
public class GraphDracula_Plaettbar implements NewPlayer {
    /* ---------------- attributes -------------- */
    /**
    ...
    /* ---------------- constructor -------------- */
    /**
     * The default constructor for {@code GraphDracula_Plaettbar}
     */
    public GraphDracula_Plaettbar() {
        this.name = "GraphDracula_Plaettbar";
        this.sampleSize = 30;
    ...
    /**
     * Constructs a {@code GraphDracula_Plaettbar} with the specified strategies
     *
     * @param maxStrat the {@link MaximizingStrategy} we choose
     * @param minStrat the {@link MinimizingStrategy} we choose
     */
    public GraphDracula_Plaettbar(MaximizingStrategy maxStrat, MinimizingStrategy minStrat) {
        this.sampleSize = 30;
        this.vertexSampleSize = 1;
        this.percentage = 0.93;
        this.fieldPercentage = 17;
    ...
    /**
     * Constructs a {@code GraphDracula_Plaettbar} with the specified initial
     * attribute
     ...
     * @param minStrat           the {@link MinimizingStrategy} we choose
     */
    public GraphDracula_Plaettbar(double percentage, double relativeCircleSize, int sampleSize, int vertexSampleSize,
        ...
        // fixed attributes
        this.name = "GraphDracula_" + maxStrat + "_" + minStrat + "_" + percentage + "_" + relativeCircleSize + "_"
