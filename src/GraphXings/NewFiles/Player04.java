 ...
 */
public class Player04 implements NewPlayer {
    /**
     ...
     * @param name
     */
    public Player04(String name, int sampleSize, double percentage, Strategy strategy) {
        this.name = name;
    ...
    public GameMove getBruteForceMove(boolean maximize, boolean includeAngles) {
        ...
        betterEdgeCrossingRTree.insertVertex(v);
