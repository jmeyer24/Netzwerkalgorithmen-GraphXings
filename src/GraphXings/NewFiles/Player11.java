 ...
 */
public class Player11 implements NewPlayer {
    /* ---------------- attributes -------------- */
    /**
    ...
    /* ---------------- constructor -------------- */
    /**
     * The default constructor for {@code Player11}
     */
    public Player11() {
        this.name = "Player11";
        this.sampleSize = 30;
    ...
    /**
     * Constructs a {@code Player11} with the specified initial attribute
     ...
     */
    public Player11(double percentage, double relativeCircleSize, int sampleSize, int vertexSampleSize,
            Strategy strategy) {
        ...
        // fixed attributes
        this.name = "Player11_" + strategy + "_" + percentage + "_" + relativeCircleSize + "_"
                + sampleSize + "_"
                + vertexSampleSize;
        this.r = new Random(this.name.hashCode());
    }
