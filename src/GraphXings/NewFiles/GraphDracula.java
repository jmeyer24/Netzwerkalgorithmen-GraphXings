 ...
 */
public class GraphDracula implements NewPlayer {
    /* ---------------- attributes -------------- */
    /**
    ...
    /* ---------------- constructor -------------- */
    /**
     * The default constructor for {@code GraphDracula}
     */
    public GraphDracula() {
        this.name = "GraphDracula";
        this.sampleSize = 30;
    ...
    /**
     * Constructs a {@code GraphDracula} with the specified initial attribute
     ...
     */
    public GraphDracula(double percentage, double relativeCircleSize, int sampleSize, int vertexSampleSize,
