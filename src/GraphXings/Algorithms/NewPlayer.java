...
public interface NewPlayer {
	 ...
	 * crossings! In a valid move, an unplaced vertex of g is positioned onto a free
	 * coordinate.
	 * 
	 * @param lastMove The last move performed by the opposing player. Is null if it
	 *                 is the first move!
	...
	/**
	 * Tells the player to perform the next move where the objective is to create
	 * crossings of low crossing angles! In a valid move, an unplaced vertex of g is
	 * positioned onto a free coordinate.
	 * 
	 * @param lastMove The last move performed by the opposing player. Is null if it
	 *                 is the first move!
	 * @return The move to be performed.
	...
	/**
	 * Tells the player to perform the next move where the objective is to avoid
	 * crossings of low crossings angles! In a valid move, an unplaced vertex of g
	 * is positioned onto a free coordinate.
	 * 
	 * @param lastMove The last move performed by the opposing player. Is null if it
	 *                 is the first move!
	 * @return The move to be performed.
	 ...
	 * MAX_ANGLE - The objective is to maximize the sum of the squared cosines of
	 * the crossing angles.
	 * MIN_ANGLE - The objective is to minimize the sum of the squared cosines of
	 * the crossing angles.
	 */
	public enum Role {
